...
arg_parser.add_argument(
    "pubspec", default="pubspec.yaml", help="Path to the build.gradle"
)
arg_parser.add_argument("new_version", help="Name of the new version")
...
def increase_build_number(path_to_pubspec, version_name):
    ...
    with open(path_to_pubspec, "wt") as f:
        f.write(r.sub("version: %s" % f"{version_name}+{code}", pubspec))
